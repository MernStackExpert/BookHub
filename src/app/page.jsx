      ...
      <section className="py-24 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-slate-900/40 p-8 rounded-2xl border border-slate-800 hover:border-teal-400/40 transition shadow-xl hover:shadow-teal-900/30">
            ...
            <div className="bg-slate-900/40 p-8 rounded-2xl border border-slate-800 hover:border-amber-400/40 transition shadow-xl hover:shadow-amber-900/30">
            ...
            <div className="bg-slate-900/40 p-8 rounded-2xl border border-slate-800 hover:border-rose-400/40 transition shadow-xl hover:shadow-rose-900/30">
